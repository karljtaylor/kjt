...
<form style="border:1px solid #ccc;padding:3px;text-align:center;" action="https://tinyletter.com/karljtaylor" method="post" target="popupwindow" onsubmit="window.open('https://tinyletter.com/karljtaylor', 'popupwindow', 'scrollbars=no,width=800,height=600');return true"><p><label for="tlemail">Never miss an update! Enter your email address to subscribe!</label></p><p><input type="text" style="width:140px" name="email" id="tlemail”, input align=Center, display=block/></p><input type="hidden" value="example@email.com" name="embed", align=Center/><input type="submit" value="Subscribe Now", text-align=Center/><p>
  
  <form style="border:1px solid #ccc;padding:3px;text-align: center !important;" action="https://tinyletter.com/karljtaylor" method="post" target="popupwindow" onsubmit="window.open('https://tinyletter.com/karljtaylor', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true" _lpchecked="1">
   <p style="
    display: flex;
    align-items: center;
